...
function Inicio() {
  return (
    <div>
      ...
      <h1>Cervezas</h1>
      <p>
        ¿Busca degustar sabores nuevos para su paladar? En <span>Beers CVJS Dev's</span> aprenderá de la mano de expertos a
        degustar las mejores <span>cervezas</span> para toda ocasión.
      </p>
      <h1>Historia</h1>
      <p>
        <span>Beers CVJS Dev's</span> nace de la unión de 4 estudiantes de programación con el sueño de crear una página ventas funcional para un público joven
        que esté dispuesto a conocer y desgudtar de una buena cerveza.
      </p>
    </div>
  );
}
